...
public class DownloadProductAdapter extends RecyclerView.Adapter<DownloadProductAdapter.ViewHolder> {
    ...
    public DownloadProductAdapter(Context context, List<Productdata> listdata) {
    ...
    @NonNull
    @Override
    public DownloadProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DownloadProductAdapter.ViewHolder holder, int position) {
